        ...
        <Card className='col-md-3 cadKep' style={{ width: '18rem' }}>
            ...
            <Card.Body>
                ...
                <div className='gombok'>
                    <Button className='float-left ' variant="danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
